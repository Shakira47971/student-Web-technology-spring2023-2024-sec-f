...
<body>
        ...
        <tr>
            <td><b>xCompany   <span style="padding: 120px;"align=right"></b><a style="color:rgb(0, 102, 255); " href="Home.php">Home</a>|
        ...
        <fieldset style="width: 300;">
           <legend><b>FORGOT PASSWORD</b></legend>
            <table>
                <tr>
            <td align="left">Enter Email</td><td><span style="padding: 3px;">:<input type="username" name="username" value=""></span></td>
</tr>
